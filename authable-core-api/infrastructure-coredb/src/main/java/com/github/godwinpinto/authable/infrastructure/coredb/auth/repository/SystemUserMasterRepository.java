...
@Transactional
@Repository
public interface SystemUserMasterRepository extends ReactiveCrudRepository<SystemUserMasterEntity, String> {

    @Modifying
    @Query(value = "update SYSTEM_USER_MASTER SM set SM.NO_OF_ATTEMPTS = :noOfAttempts, SM.INVALID_ATTEMPT_DATE_TIME = :invalidAttemptDateTime where SM.ACCESS_ID = :accessId ")
    ...
    @Modifying
    @Query("UPDATE SYSTEM_USER_MASTER SM SET SM.LAST_LOGIN_DATE_TIME = :lastLoginDateTime, SM.NO_OF_ATTEMPTS = 0, SM.INVALID_ATTEMPT_DATE_TIME = NULL WHERE SM.ACCESS_ID = :accessId")
    ...
    @Modifying
    @Query("UPDATE SYSTEM_USER_MASTER SM SET SM.LOCKED_DATE_TIME = :lockedDateTime, SM.STATUS = :status WHERE SM.ACCESS_ID = :accessId")
