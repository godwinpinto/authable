...
class GenerateQrResponseTest {
  ...
  void testConstructor() {
    ...
    assertEquals(
        "GenerateQrResponse(statusCode=Status Code, statusDescription=Status Description, qrImage=Qr Image)",
  ...
  void testConstructor2() {
    GenerateQrResponse actualGenerateQrResponse =
  ...
  void testEquals4() {
    GenerateQrResponse generateQrResponse =
        new GenerateQrResponse("Status Description", "Status Description", "Qr Image");
    assertNotEquals(
        generateQrResponse,
        new GenerateQrResponse("Status Code", "Status Description", "Qr Image"));
  }
  ...
  void testEquals5() {
    GenerateQrResponse generateQrResponse =
        new GenerateQrResponse(null, "Status Description", "Qr Image");
    assertNotEquals(
        generateQrResponse,
        new GenerateQrResponse("Status Code", "Status Description", "Qr Image"));
  }
  ...
  void testEquals6() {
    GenerateQrResponse generateQrResponse =
        new GenerateQrResponse("Status Code", "Status Code", "Qr Image");
    assertNotEquals(
        generateQrResponse,
        new GenerateQrResponse("Status Code", "Status Description", "Qr Image"));
  }
  ...
  void testEquals8() {
    GenerateQrResponse generateQrResponse =
        new GenerateQrResponse("Status Code", "Status Description", "Status Code");
    assertNotEquals(
        generateQrResponse,
        new GenerateQrResponse("Status Code", "Status Description", "Qr Image"));
  }
  ...
  void testEquals9() {
    GenerateQrResponse generateQrResponse =
        new GenerateQrResponse("Status Code", "Status Description", null);
    assertNotEquals(
        generateQrResponse,
        new GenerateQrResponse("Status Code", "Status Description", "Qr Image"));
  }
  ...
  void testEquals11() {
    GenerateQrResponse generateQrResponse = new GenerateQrResponse("Status Code", null, "Qr Image");
    GenerateQrResponse generateQrResponse2 =
        new GenerateQrResponse("Status Code", null, "Qr Image");
