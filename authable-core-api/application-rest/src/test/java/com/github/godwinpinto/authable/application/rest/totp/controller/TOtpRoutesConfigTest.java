...
@ContextConfiguration(classes = {TOtpRoutesConfig.class,
...
class TOtpRoutesConfigTest {
    ...
    /**
     * Method under test: {@link TOtpRoutesConfig#getStatus(TOtpStatusHandler, TOtpVerifyHandler, TOtpUnBlockHandler, TOtpUnSubscribeHandler, TOtpGenerateQrHandler, TOtpSubscribeHandler)}
     */
    @Test
    void testGetStatus() {
        ...
        tOtpRoutesConfig.getStatus(tOtpStatusHandler, tOtpVerifyHandler, tOtpUnBlockHandler, tOtpUnSubscribeHandler,
