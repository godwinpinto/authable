...
class SystemUserMasterDtoTest {
  ...
  void testConstructor() {
    ...
    LocalDateTime invalidAttemptDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    actualSystemUserMasterDto.setInvalidAttemptDateTime(invalidAttemptDateTime);
    LocalDateTime lastLoginDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    actualSystemUserMasterDto.setLastLoginDateTime(lastLoginDateTime);
    LocalDateTime lockedDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
  ...
  void testEquals() {
    ...
    systemUserMasterDto.setCreationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setCreationId("42");
    systemUserMasterDto.setInvalidAttemptDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLastLoginDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLockedDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
  ...
  void testEquals4() {
    ...
    systemUserMasterDto2.setCreationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto2.setCreationId("42");
    systemUserMasterDto2.setInvalidAttemptDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto2.setLastLoginDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto2.setLockedDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto2.setModificationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
  ...
  void testEquals7() {
    SystemUserMasterDto systemUserMasterDto = new SystemUserMasterDto();
    systemUserMasterDto.setAccessId("42");
    systemUserMasterDto.setCreationDateTime(LocalDate.now().atStartOfDay());
    systemUserMasterDto.setCreationId("42");
    systemUserMasterDto.setInvalidAttemptDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLastLoginDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLockedDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
  ...
  void testEquals10() {
    ...
    systemUserMasterDto.setCreationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setCreationId("42");
    systemUserMasterDto.setInvalidAttemptDateTime(LocalDate.now().atStartOfDay());
    systemUserMasterDto.setLastLoginDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLockedDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationId("42");
  ...
  void testEquals11() {
    ...
    systemUserMasterDto.setCreationId("42");
    systemUserMasterDto.setInvalidAttemptDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLastLoginDateTime(LocalDate.now().atStartOfDay());
    systemUserMasterDto.setLockedDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationId("42");
    systemUserMasterDto.setNoOfAttempts((short) 1);
  ...
  void testEquals12() {
    ...
    systemUserMasterDto.setInvalidAttemptDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLastLoginDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLockedDateTime(LocalDate.now().atStartOfDay());
    systemUserMasterDto.setModificationDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationId("42");
    systemUserMasterDto.setNoOfAttempts((short) 1);
    systemUserMasterDto.setStatus("Status");
  ...
  void testEquals13() {
    ...
    systemUserMasterDto.setLastLoginDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setLockedDateTime(LocalDate.of(1970, 1, 1).atStartOfDay());
    systemUserMasterDto.setModificationDateTime(LocalDate.now().atStartOfDay());
    systemUserMasterDto.setModificationId("42");
    systemUserMasterDto.setNoOfAttempts((short) 1);
    systemUserMasterDto.setStatus("Status");
    systemUserMasterDto.setSystemId("42");
