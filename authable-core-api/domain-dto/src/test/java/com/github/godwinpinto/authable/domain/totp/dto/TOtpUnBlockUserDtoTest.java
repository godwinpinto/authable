...
class TOtpUnBlockUserDtoTest {
  ...
  @Test
  void testCanEqual2() {
    TOtpUnBlockUserDto tOtpUnBlockUserDto =
        new TOtpUnBlockUserDto("Status Code", "Status Description");
    assertTrue(
        tOtpUnBlockUserDto.canEqual(new TOtpUnBlockUserDto("Status Code", "Status Description")));
  }
  ...
  void testConstructor() {
    ...
    assertEquals(
        "TOtpUnBlockUserDto(statusCode=Status Code, statusDescription=Status Description)",
  ...
  void testConstructor2() {
    TOtpUnBlockUserDto actualTOtpUnBlockUserDto =
        new TOtpUnBlockUserDto("Status Code", "Status Description");
    actualTOtpUnBlockUserDto.setStatusCode("Status Code");
    actualTOtpUnBlockUserDto.setStatusDescription("Status Description");
    String actualToStringResult = actualTOtpUnBlockUserDto.toString();
  ...
  void testEquals3() {
    TOtpUnBlockUserDto tOtpUnBlockUserDto =
        new TOtpUnBlockUserDto("Status Code", "Status Description");
    TOtpUnBlockUserDto tOtpUnBlockUserDto2 =
        new TOtpUnBlockUserDto("Status Code", "Status Description");
  ...
  void testEquals4() {
    TOtpUnBlockUserDto tOtpUnBlockUserDto =
        new TOtpUnBlockUserDto("Status Description", "Status Description");
    assertNotEquals(
        tOtpUnBlockUserDto, new TOtpUnBlockUserDto("Status Code", "Status Description"));
  }
