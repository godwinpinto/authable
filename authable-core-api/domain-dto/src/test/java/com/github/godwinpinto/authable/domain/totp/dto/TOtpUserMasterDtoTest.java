...
class TOtpUserMasterDtoTest {
  ...
  void testCanEqual2() {
    ...
    LocalDateTime lockedDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    TOtpUserMasterDto tOtpUserMasterDto =
        new TOtpUserMasterDto(
            "42",
            "42",
            "User Secret",
            ...
            "42",
            LocalDate.of(1970, 1, 1).atStartOfDay());
    LocalDateTime lastLoginDateTime2 = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime invalidAttemptDateTime2 = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime lockedDateTime2 = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime2 = LocalDate.of(1970, 1, 1).atStartOfDay();
    assertTrue(
        tOtpUserMasterDto.canEqual(
            new TOtpUserMasterDto(
                "42",
                "42",
                "User Secret",
                (short) 1,
                lastLoginDateTime2,
                invalidAttemptDateTime2,
                lockedDateTime2,
                "Access Type",
                "Status",
                "42",
                modificationDateTime2,
                "42",
                LocalDate.of(1970, 1, 1).atStartOfDay())));
  }
   ...
   *
   * <ul>
   *   <li>{@link TOtpUserMasterDto#TOtpUserMasterDto(String, String, String, short, LocalDateTime,
   *       LocalDateTime, LocalDateTime, String, String, String, LocalDateTime, String,
   *       LocalDateTime)}
  ...
  void testConstructor() {
    ...
    LocalDateTime lockedDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    TOtpUserMasterDto actualTOtpUserMasterDto =
        new TOtpUserMasterDto(
            "42",
            "42",
            "User Secret",
    ...
    assertEquals(
        "TOtpUserMasterDto(userId=42, systemId=42, userSecret=User Secret, noOfAttempts=1, lastLoginDateTime"
            ...
            + " creationId=42, creationDateTime=1970-01-01T00:00)",
  ...
  void testEquals2() {
    ...
    assertNotEquals(
        new TOtpUserMasterDto(
            ...
            "42",
            LocalDate.of(1970, 1, 1).atStartOfDay()),
        "Different type to TOtpUserMasterDto");
  }
  ...
  void testEquals4() {
    ...
    LocalDateTime lockedDateTime2 = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime2 = LocalDate.of(1970, 1, 1).atStartOfDay();
    TOtpUserMasterDto tOtpUserMasterDto2 =
        new TOtpUserMasterDto(
            "42",
            "42",
            "User Secret",
  ...
  @Test
  void testEquals12() {
    LocalDateTime lastLoginDateTime = LocalDate.now().atStartOfDay();
    LocalDateTime invalidAttemptDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime lockedDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    TOtpUserMasterDto tOtpUserMasterDto =
  ...
  void testEquals13() {
    LocalDateTime lastLoginDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime invalidAttemptDateTime = LocalDate.now().atStartOfDay();
    LocalDateTime lockedDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    TOtpUserMasterDto tOtpUserMasterDto =
        new TOtpUserMasterDto(
  ...
  void testEquals14() {
    LocalDateTime lastLoginDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime invalidAttemptDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime lockedDateTime = LocalDate.now().atStartOfDay();
    LocalDateTime modificationDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    TOtpUserMasterDto tOtpUserMasterDto =
        new TOtpUserMasterDto(
            "42",
  ...
  void testEquals21() {
    ...
    LocalDateTime invalidAttemptDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime lockedDateTime = LocalDate.of(1970, 1, 1).atStartOfDay();
    LocalDateTime modificationDateTime = LocalDate.now().atStartOfDay();
    TOtpUserMasterDto tOtpUserMasterDto =
        new TOtpUserMasterDto(
            "42",
            "42",
