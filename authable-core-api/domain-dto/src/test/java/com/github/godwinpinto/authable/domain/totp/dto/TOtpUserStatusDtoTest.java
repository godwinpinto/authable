...
class TOtpUserStatusDtoTest {
  ...
  void testCanEqual2() {
    TOtpUserStatusDto tOtpUserStatusDto =
        new TOtpUserStatusDto("Status Code", "Status Description");
    assertTrue(
        tOtpUserStatusDto.canEqual(new TOtpUserStatusDto("Status Code", "Status Description")));
  }
  ...
  void testConstructor() {
    ...
    assertEquals(
        "TOtpUserStatusDto(statusCode=Status Code, statusDescription=Status Description)",
  ...
  void testConstructor2() {
    TOtpUserStatusDto actualTOtpUserStatusDto =
        new TOtpUserStatusDto("Status Code", "Status Description");
    actualTOtpUserStatusDto.setStatusCode("Status Code");
    actualTOtpUserStatusDto.setStatusDescription("Status Description");
    String actualToStringResult = actualTOtpUserStatusDto.toString();
  ...
  void testEquals3() {
    TOtpUserStatusDto tOtpUserStatusDto =
        new TOtpUserStatusDto("Status Code", "Status Description");
    TOtpUserStatusDto tOtpUserStatusDto2 =
        new TOtpUserStatusDto("Status Code", "Status Description");
  ...
  void testEquals4() {
    TOtpUserStatusDto tOtpUserStatusDto =
        new TOtpUserStatusDto("Status Description", "Status Description");
