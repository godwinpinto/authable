...
class TOtpUnSubscribeUserDtoTest {
    ...
    @Test
    void testCanEqual() {
        assertFalse((new TOtpUnSubscribeUserDto("Status Code", "Status Description")).canEqual("Other"));
    }
    ...
    @Test
    void testCanEqual2() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto("Status Code", "Status Description");
        assertTrue(tOtpUnSubscribeUserDto.canEqual(new TOtpUnSubscribeUserDto("Status Code", "Status Description")));
    }
    ...
    void testConstructor() {
        ...
        assertEquals("TOtpUnSubscribeUserDto(statusCode=Status Code, statusDescription=Status Description)",
    ...
    void testConstructor2() {
        TOtpUnSubscribeUserDto actualTOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto("Status Code",
                "Status Description");
        actualTOtpUnSubscribeUserDto.setStatusCode("Status Code");
        actualTOtpUnSubscribeUserDto.setStatusDescription("Status Description");
        String actualToStringResult = actualTOtpUnSubscribeUserDto.toString();
    ...
    void testEquals() {
        ...
        assertNotEquals(new TOtpUnSubscribeUserDto("Status Code", "Status Description"),
    ...
    @Test
    void testEquals4() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto("Status Description",
                "Status Description");
        assertNotEquals(tOtpUnSubscribeUserDto, new TOtpUnSubscribeUserDto("Status Code", "Status Description"));
    }
    ...
    @Test
    void testEquals5() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto(null, "Status Description");
        assertNotEquals(tOtpUnSubscribeUserDto, new TOtpUnSubscribeUserDto("Status Code", "Status Description"));
    }
    ...
    @Test
    void testEquals6() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto("Status Code", "Status Code");
        assertNotEquals(tOtpUnSubscribeUserDto, new TOtpUnSubscribeUserDto("Status Code", "Status Description"));
    }
    ...
    void testEquals8() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto(null, "Status Description");
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto2 = new TOtpUnSubscribeUserDto(null, "Status Description");
    ...
    void testEquals9() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto("Status Code", null);
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto2 = new TOtpUnSubscribeUserDto("Status Code", null);
    ...
    @Test
    void testBuilder() {
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto = new TOtpUnSubscribeUserDto("Status Code", "DESCRIPTION");
        TOtpUnSubscribeUserDto tOtpUnSubscribeUserDto2 = TOtpUnSubscribeUserDto.builder()
