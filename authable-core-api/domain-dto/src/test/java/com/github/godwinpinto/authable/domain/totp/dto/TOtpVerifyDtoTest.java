...
class TOtpVerifyDtoTest {
    ...
    void testConstructor() {
        ...
        assertEquals("TOtpVerifyDto(statusCode=Status Code, statusDescription=Status Description)", actualToStringResult);
    }
    ...
    void testEquals() {
        ...
        assertNotEquals(new TOtpVerifyDto("Status Code", "Status Description"), "Different type to TOtpVerifyDto");
    }
    ...
    void testBuilder() {
        ...
        TOtpVerifyDto tOtpVerifyDto2 = TOtpVerifyDto.builder()
