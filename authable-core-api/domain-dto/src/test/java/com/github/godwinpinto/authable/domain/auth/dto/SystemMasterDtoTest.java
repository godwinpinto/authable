...
class SystemMasterDtoTest {
    ...
    void testEquals() {
        ...
        systemMasterDto.setCreationDateTime(LocalDate.of(1970, 1, 1)
                .atStartOfDay());
        systemMasterDto.setCreationId("42");
        systemMasterDto.setModificationDateTime(LocalDate.of(1970, 1, 1)
                .atStartOfDay());
    ...
    void testEquals4() {
        ...
        systemMasterDto2.setCreationDateTime(LocalDate.of(1970, 1, 1)
                .atStartOfDay());
        systemMasterDto2.setCreationId("42");
        systemMasterDto2.setModificationDateTime(LocalDate.of(1970, 1, 1)
                .atStartOfDay());
    ...
    void testEquals5() {
        SystemMasterDto systemMasterDto = new SystemMasterDto();
        systemMasterDto.setCreationDateTime(LocalDate.now()
                .atStartOfDay());
        systemMasterDto.setCreationId("42");
        systemMasterDto.setModificationDateTime(LocalDate.of(1970, 1, 1)
                .atStartOfDay());
    ...
    void testEquals8() {
        ...
        systemMasterDto.setCreationDateTime(LocalDate.of(1970, 1, 1)
                .atStartOfDay());
        systemMasterDto.setCreationId("42");
        systemMasterDto.setModificationDateTime(LocalDate.now()
                .atStartOfDay());
        systemMasterDto.setModificationId("42");
        systemMasterDto.setStatus("Status");
        systemMasterDto.setSystemDescription("System Description");
