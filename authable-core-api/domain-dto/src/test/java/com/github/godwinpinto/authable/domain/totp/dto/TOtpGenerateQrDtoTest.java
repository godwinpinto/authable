...
class TOtpGenerateQrDtoTest {
    ...
    @Test
    void testCanEqual() {
        assertFalse((new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image")).canEqual("Other"));
    }
    ...
    @Test
    void testCanEqual2() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image");
        assertTrue(tOtpGenerateQrDto.canEqual(new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image")));
    }
    ...
    void testConstructor() {
        ...
        assertEquals("TOtpGenerateQrDto(statusCode=Status Code, statusDescription=Status Description, qrImage=Qr Image)",
    ...
    void testConstructor2() {
        TOtpGenerateQrDto actualTOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Description",
                "Qr Image");
        actualTOtpGenerateQrDto.setQrImage("Qr Image");
        actualTOtpGenerateQrDto.setStatusCode("Status Code");
        actualTOtpGenerateQrDto.setStatusDescription("Status Description");
    ...
    void testEquals() {
        ...
        assertNotEquals(new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image"),
    ...
    void testEquals3() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image");
        TOtpGenerateQrDto tOtpGenerateQrDto2 = new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image");
    ...
    @Test
    void testEquals4() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Description", "Status Description",
                "Qr Image");
        assertNotEquals(tOtpGenerateQrDto, new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image"));
    }
    ...
    @Test
    void testEquals5() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto(null, "Status Description", "Qr Image");
        assertNotEquals(tOtpGenerateQrDto, new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image"));
    }
    ...
    @Test
    void testEquals6() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Code", "Qr Image");
        assertNotEquals(tOtpGenerateQrDto, new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image"));
    }
    ...
    @Test
    void testEquals8() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Description", "Status Code");
        assertNotEquals(tOtpGenerateQrDto, new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image"));
    }
    ...
    @Test
    void testEquals9() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Description", null);
        assertNotEquals(tOtpGenerateQrDto, new TOtpGenerateQrDto("Status Code", "Status Description", "Qr Image"));
    }
    ...
    void testEquals10() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto(null, "Status Description", "Qr Image");
        TOtpGenerateQrDto tOtpGenerateQrDto2 = new TOtpGenerateQrDto(null, "Status Description", "Qr Image");
    ...
    void testEquals12() {
        TOtpGenerateQrDto tOtpGenerateQrDto = new TOtpGenerateQrDto("Status Code", "Status Description", null);
        TOtpGenerateQrDto tOtpGenerateQrDto2 = new TOtpGenerateQrDto("Status Code", "Status Description", null);
    ...
    @Test
    void testBuilder() {
        TOtpGenerateQrDto tOtpCreateNewDto = new TOtpGenerateQrDto("Status Code", "DESCRIPTION",
                "IMAGE");
        TOtpGenerateQrDto tOtpCreateNewDto2 = TOtpGenerateQrDto.builder()
